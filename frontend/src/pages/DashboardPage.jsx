...
const MOTIVATIONAL = {
  1:  ['Keep the momentum! 🔥', 'You showed up. That\'s everything.', 'One more brick in the wall.', 'Compounding starts now.'],
  0:  ['Neutral days are rest days.', 'Stability is underrated.', 'Tomorrow you go +1.', 'Consistency over perfection.'],
  '-1': ['Honesty takes courage.', 'Down days make up days sweeter.', 'The streak isn\'t broken. You logged it.', 'Tomorrow is a clean slate.'],
};
